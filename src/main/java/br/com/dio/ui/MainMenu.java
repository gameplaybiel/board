...
public class MainMenu {
    ...
    private void createBoard() throws SQLException {
        ...
        System.out.println("Seu board terá coluna além das 3 padrões? Se sim, informe quantas, senão, digite '0'");
        ...
        for (int i = 0; i < additionalColumns; i++) {
            System.out.println("Digite o nome da coluna da tarefa pendente do board");
            var pendingColumnName = scanner.next();
            var pendingColumn = createColumn(pendingColumnName, PENDING, i + 1);
            columns.add(pendingColumn);
        }

        System.out.println("Digite o nome da coluna final do board");
    ...
    private void selectedBoard() throws SQLException {
